...
function preload ()
{
    ...
    this.load.image('phaser', './assets/building1.png',
...
function create ()
{
    ...
    this.myImage = this.add.sprite(window.innerWidth/2, window.innerHeight/2, 'phaser').setPipeline('Light2D');
    // this.myImage.displayHeight = window.innerHeight 
    // this.myImage.displayWidth =  window.innerWidth 
    this.myImage.setScrollFactor(0);

    this.lights.addLight(0, 100, 100).setColor(0x171717).setIntensity(3.0);
    this.lights.addLight(0, 200, 100).setColor(0x171717).setIntensity(3.0);
    this.lights.addLight(0, 300, 100).setColor(0x171717).setIntensity(3.0);
    this.lights.addLight(0, 400, 100).setColor(0x171717).setIntensity(3.0);
