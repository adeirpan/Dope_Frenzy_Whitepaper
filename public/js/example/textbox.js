...
function create ()
{
    ...
    graphics.fillRect(152, 133, 400, 300);

    var mask = new Phaser.Display.Masks.GeometryMask(this, graphics);

    var text = this.add.text(160, 280, content, { fontFamily: 'Arial', color: '#00ff00', wordWrap: { width: 400 } }).setOrigin(0);

    text.setMask(mask);

    //  The rectangle they can 'drag' within
    var zone = this.add.zone(152, 130, 400, 256).setOrigin(0).setInteractive();
