...
export default class Game extends Phaser.Scene {
    ...
    preload() {
        this.load.image('bg', './js/example/Resize/src/scenes/assets/background.jpg');
        this.load.image('logo', './js/example/Resize/src/scenes/assets/logo.png')
        this.load.image('logoPhaser', './js/example/Resize/src/scenes/assets/phaser3-logo.png')
